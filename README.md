...
(1) Sorted the main dataset by slecting althlet that their hight is above 190cm (Height is advantage in some olympic games) saved the new file as cleaned_row.csv.      
